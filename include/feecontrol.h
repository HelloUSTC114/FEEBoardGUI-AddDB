...
public:
    ...
    bool tdc_queue_length_read_no_timewait(int &len);
...
private:
    ...
    // void CloseSock();
    bool start_socket();
    bool start_socket_no_timewait();
    void close_socket();
    bool length_read(cmd_up cmd, int &len);
    bool length_read_no_timewait(cmd_up cmd, int &len);
...
public:
    ...
    {
        std::cout << "Error!" << "Board " << boardNo << " Connection Broken." << std::endl;
